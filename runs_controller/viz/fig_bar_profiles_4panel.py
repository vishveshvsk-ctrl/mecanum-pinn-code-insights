...
lo = df["track"].min() * 0.6; hi = df["track"].max() * 2.5
...
fig.savefig("runs_controller/viz/fig_bar_profiles_4panel.png", dpi=155, bbox_inches="tight")
print("saved runs_controller/viz/fig_bar_profiles_4panel.png")
