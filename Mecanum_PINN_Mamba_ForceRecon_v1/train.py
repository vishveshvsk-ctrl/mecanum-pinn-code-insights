...
Usage (from code_insights/):
    ...
    python Mecanum_PINN_Mamba_ForceRecon_v1/train.py inverse --ckpt checkpoints_mamba_v1/<tag>/forward_lbfgs.pth
    python Mecanum_PINN_Mamba_ForceRecon_v1/train.py figures --ckpt checkpoints_mamba_v1/<tag>/inverse_lbfgs.pth
...
(`cache_dir` below); override the location with --cache-dir, disable with
`--cache-dir ''`. Point `whitelist_path` at the list exported from
...
if __name__ == '__main__':
    run_main(
        config_kwargs=dict(
            vram_gb=24,
            cache_dir='Mecanum_PINN_Mamba_ForceRecon_v1/cache_decim',
