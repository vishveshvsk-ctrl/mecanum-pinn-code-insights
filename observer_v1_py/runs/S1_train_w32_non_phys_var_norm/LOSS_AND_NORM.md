# Run: S1_train_w32  (NON-PHYSICS, VAR-NORMALIZED)
...
## Result
- model=ssm window=32 stride=16 regime=S1_train epochs=119 params=6277
- final val_loss (z-scored mean per-state MSE) = 0.0220
