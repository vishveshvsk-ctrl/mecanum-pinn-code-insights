# Run: S2_train_w16  (NON-PHYSICS, VAR-NORMALIZED)
...
## Result
- model=ssm window=16 stride=8 regime=S2_train epochs=119 params=6277
- final val_loss (z-scored mean per-state MSE) = 0.0259
