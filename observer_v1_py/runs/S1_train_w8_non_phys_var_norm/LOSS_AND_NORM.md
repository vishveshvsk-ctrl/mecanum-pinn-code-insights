# Run: S1_train_w8  (NON-PHYSICS, VAR-NORMALIZED)
...
## Result
- model=ssm window=8 stride=4 regime=S1_train epochs=119 params=6277
- final val_loss (z-scored mean per-state MSE) = 0.0275
