@echo off
REM Windows launcher: smoke test for IMMKalmanEstimator + BlackBoxOptim dxnes backend.
...
"%JULIA_EXE%" -t4 --project="%ROOT%" tune_estimator.jl --estimator kalman_imm --optimizer dxnes --budget 4 --max-parallel 4 --seed 42 --out runs_estimator_imm_smoke
pause
